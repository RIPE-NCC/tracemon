(function (window) {
    ...
    c3_chart_internal_fn.lineWithRegions = function (d, x, y, _regions) {
        ...
        for (i = 0; i < d.length; i++) {
            ...
            // Draw with region // TODO: Fix for horizotal charts
                ...
                diff = 1; // just hide regions motherfucker!
    ...
    c3_chart_internal_fn.generateDrawArea = function (areaIndices, isSub) {
        ...
        if (!config.line_connect_null) {
            area = area.defined(function (d) { d.value !== null; }); // DEFINED TRUE QUI
        }

        //Forse meglio inviare valori nulli con il connettore in modo che si percepisca anche l'evoluzione del
        // grafico quando non si ricevono valori
        //e non devo modificare la libreria
